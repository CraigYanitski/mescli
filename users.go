...
type InitUser struct {
    ...
    IdentityKey     ecdsa.PublicKey  `json:"identity_key"`
    SignedPrekey    ecdh.PublicKey   `json:"signed_key"`
    SignedKey       ecdh.PublicKey   `json:"signed_prekey"`
}
type User struct {
...
func (cfg *apiConfig) handleCreateUser(w http.ResponseWriter, r *http.Request) {
    ...
    params := database.CreateUserParams{
        ...
        IdentityKey: hex.EncodeToString(idkBytes),
        SignedPrekey: hex.EncodeToString(spkBytes),
        SignedKey: hex.EncodeToString(skBytes),
    }
